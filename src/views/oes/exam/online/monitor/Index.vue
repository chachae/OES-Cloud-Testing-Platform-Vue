    ...
    <el-row :gutter="10">
      <el-col :xs="24" :sm="12">
        <div class="app-container">
          ...
          >
            <p>
              本在线考试反作弊系统的多对一摄像头与屏幕共享远程监控服务是基于 Netty 4 开发的高性能 WebSocket 长连接服务，使用 WebRTC 技术实现实时流媒体传输，
              已知在4核8G服务器上有超强的表现能力，通过 JMeter 可靠压测，单机可同时稳定承载 500,000+ 空连接，建议在现代化浏览器（Chrome，Firefox） 上使用。
            </p>
          </div>
