...
<template>
  <div>
    ...
    >
      ...
      <p>
        <strong>期末考试将至，为创造诚信、公平、公正的考试环境，我班全体同学承诺如下：</strong><br>
    ...
    <div class="view-item">
      ...
      <el-button class="filter-item" :disabled="stepNum !== 1" type="primary" plain @click="tracking">活体人脸卡证匹配</el-button>
      <el-button class="filter-item" :disabled="stepNum !== 2" type="primary" plain @click="connectDevices">设备监控</el-button>
