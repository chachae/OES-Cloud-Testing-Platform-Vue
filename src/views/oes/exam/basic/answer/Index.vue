<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-dropdown
        v-has-any-permission="['answer:view','answer:add','answer:delete']"
        trigger="click"
        class="filter-item"
      >
        <el-button>
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item v-has-permission="['answer:delete']">{{ $t('table.delete') }}
          </el-dropdown-item>
          <el-dropdown-item v-has-permission="['answer:export']" @click.native="exportExcel">{{ $t('table.export') }}
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
