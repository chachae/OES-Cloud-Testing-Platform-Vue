...
<script>
import QiNiuAPI from '@/api/oss/qiniu'
...
export default {
  ...
  methods: {
    ...
    synchronized() {
      QiNiuAPI.synchronize()
      this.search()
    },
    getConfig() {
      QiNiuAPI.getConfig().then((r) => {
