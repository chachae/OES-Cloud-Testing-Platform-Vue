export default {
  ...
  common: {
    ...
    desc: {
      a: '基于Spring Boot 2.2.6 & Spring Cloud Hoxton.SR3 & Alibaba',
      b: '使用Spring Cloud OAuth2.0统一认证',
      c: '认证服务器资源服务器分离，方便拓展',
      d: '前后端分离架构，提高软件开发效率',
      e: '集成多种监控治理，为微服务保驾护航',
      f: '考试过程自动化控制与人脸识别混合监考',
